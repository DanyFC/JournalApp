...
const Note = () => {
  ...
  useLayoutEffect(() => {
    gridElement.current.className = 'hidden'
    setTimeout(() => {
      gridElement.current.className = 'animate__animated animate__slideInLeft'
    }, 500)
  ...
  return (
    <div ref={gridElement}>
      <Grid container direction='row' justifyContent='space-between' alignContent='start' sx={{ mb: 1, minHeight: 'calc(100vh - 128px)' }}>
